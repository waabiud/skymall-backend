...
# CORS — allows React frontend to communicate with Django
...
DEFAULT_FROM_EMAIL  = os.getenv('DEFAULT_FROM_EMAIL', 'SkyMall <noreply@skymall.co.ke>')

# Allow media files from React dev server
